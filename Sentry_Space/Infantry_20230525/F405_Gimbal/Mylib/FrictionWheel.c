...
//	}
	...
	PidFrictionSpeed[0].SetPoint=-accelerator-accelerator*k_bias;     //  accelerator+bias_speed;
	PidFrictionSpeed[1].SetPoint=accelerator;
	
	if(Status.ControlMode == Control_Powerdown_Mode)
	{
		PidFrictionSpeed[0].SetPoint = 0;
		PidFrictionSpeed[1].SetPoint = 0;
	}
