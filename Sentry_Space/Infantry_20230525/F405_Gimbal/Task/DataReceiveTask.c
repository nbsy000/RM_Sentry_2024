...
float yaw_gyro_temp, pitch_gyro_temp,roll_gyro_temp;
...
//		GyroReceive.GY *= Infantry.gyro_pn;
    ...
    global_debugger.imu_debugger.recv_msgs_num[1]++;
  ...
  case 0x100:
  {
    ...
    global_debugger.imu_debugger.recv_msgs_num[0]++;
    Robot_Disconnect.Gyro_DisConnect = 0;
    break;
  }
...
// 		 case 0x102:
//		 {
//			 memcpy(&roll_gyro_temp, &rx_message1->Data, 4);
//			 memcpy(&GyroReceive.GX, &rx_message1->Data[4], 4);
//			 //程序安全
////			 if(yaw_gyro_temp < 180.0f && yaw_gyro_temp > -180.0f)
////			 {
//             GyroReceive.GX*=180/3.1415926f;
//			 GyroReceive.ROLL = -roll_gyro_temp;
//			 Robot_Disconnect.Gyro_DisConnect=0;
////			 }
//		 }
//		 break;          
