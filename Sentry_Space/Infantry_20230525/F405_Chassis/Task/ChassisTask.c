...
ChassisSpeedCal_t RealCarSpeed; //实际速度
...
/*斜着走*/	
    ...
    RealCarSpeed.SpeedX.SetPoint = (pidChassisWheelSpeed[1].SetPoint - pidChassisWheelSpeed[3].SetPoint)/2;
    RealCarSpeed.SpeedX.ActualValue = (ChassisMotorCanReceive[1].RealSpeed - ChassisMotorCanReceive[3].RealSpeed)/2;
    RealCarSpeed.SpeedY.SetPoint = (pidChassisWheelSpeed[0].SetPoint - pidChassisWheelSpeed[2].SetPoint)/2;
    RealCarSpeed.SpeedY.ActualValue = (ChassisMotorCanReceive[0].RealSpeed - ChassisMotorCanReceive[2].RealSpeed)/2;
    RealCarSpeed.SpeedW.SetPoint = (pidChassisWheelSpeed[0].SetPoint + pidChassisWheelSpeed[2].SetPoint)/2;
    RealCarSpeed.SpeedW.ActualValue = (ChassisMotorCanReceive[0].RealSpeed + ChassisMotorCanReceive[2].RealSpeed)/2;
#endif
...
*返 回 值: 无
**********************************************************************************************************/
const float HeatControlThreshold = 0.6f;   	//开启热量控制的阈值
