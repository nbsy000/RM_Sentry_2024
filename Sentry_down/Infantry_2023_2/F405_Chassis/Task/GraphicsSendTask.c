...
//	P_graphic_data = Line_Draw(0,Op_Add,SCREEN_LENGTH * 0.54, SCREEN_WIDTH * 0.45, SCREEN_LENGTH * 0.68 , 200 ,4 , Orange , LaneLineName2);
	Send_UIPack(Drawing_Graphic7_ID, JudgeReceive.robot_id, JudgeReceive.robot_id + 0x100, data_pack, DRAWING_PACK * 7); // 画7个图形
...
//      CapDraw(AD_actual_value , InitFlag);       //超级电容电量
        CapUI_Change(AD_actual_value, InitFlag);    //超级电容电压
