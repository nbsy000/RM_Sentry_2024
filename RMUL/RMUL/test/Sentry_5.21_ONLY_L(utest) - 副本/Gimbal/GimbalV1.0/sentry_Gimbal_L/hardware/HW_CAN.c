...
static void CAN1_Configuration(void)
{
    ...
    CAN_Init(CAN1, &canInit);
		...
		can_filter.CAN_FilterMode = CAN_FilterMode_IdList; 
		can_filter.CAN_FilterScale = CAN_FilterScale_16bit;
		can_filter.CAN_FilterIdHigh = 0x101<<5 ;//大Yaw轴陀螺仪
		can_filter.CAN_FilterIdLow = ChassisYaw_ID<<5;
		can_filter.CAN_FilterMaskIdHigh =  SHOOTING_HEAT_ID<<5;
		can_filter.CAN_FilterMaskIdLow =  BULLET_SPEED_ID<<5;
...
static void CAN2_Configuration(void)
{
	...
	can_filter.CAN_FilterMode = CAN_FilterMode_IdList;
	can_filter.CAN_FilterScale = CAN_FilterScale_16bit;
	can_filter.CAN_FilterIdHigh = MotoPitch_ID_L << 5;
	can_filter.CAN_FilterIdLow = MotoYaw_ID_L << 5; 
	can_filter.CAN_FilterMaskIdHigh = Remote_Control_ID <<5;
	...
	can_filter.CAN_FilterMode = CAN_FilterMode_IdList;
	can_filter.CAN_FilterScale = CAN_FilterScale_16bit;
	can_filter.CAN_FilterIdHigh = Gyro_Pitch_ID << 5;
	can_filter.CAN_FilterIdLow = 0 | CAN_ID_STD;
	can_filter.CAN_FilterMaskIdHigh = Gyro_Yaw_ID << 5;
	can_filter.CAN_FilterMaskIdLow = 0 | CAN_ID_STD;
	can_filter.CAN_FilterFIFOAssignment = 1;
	can_filter.CAN_FilterActivation = ENABLE;
	CAN_FilterInit(&can_filter);
