...
/* configUSE_STATS_FORMATTING_FUNCTIONS与宏configUSE_TRACE_FACILITY同时为1时会编译下面3个函数
...
#endif
//中断最低优先级
#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY 0x0f //即15d

//系统可管理的最高中断优先级
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY 0x02 //允许用户在这个中断服务程序里面调用 FreeRTOS 的 API 的最高优先级
...
//#define INCLUDE_xTaskGetCurrentTaskHandle 0 // 启用一个可选函数（该函数被Trace源码使用，默认该值为0 表示不用）
//#endif
