...
#define task_GimbalL_PRIO 31
#define task_GimbalL_SIZE 1024
TaskHandle_t task_GimbalL_Handler;
...
static void start_task(void *pvParameters)
{
    ...
    //云台任务
    xTaskCreate((TaskFunction_t)task_Gimbal_L,
                (const char *)"task_Gimbal_L",
                (uint16_t)task_GimbalL_SIZE,
                (void *)NULL,
                (UBaseType_t)task_GimbalL_PRIO,
                (TaskHandle_t *)&task_GimbalL_Handler);
